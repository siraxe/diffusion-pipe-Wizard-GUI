    ...
    sections: list[tuple[str, list[tuple[str, str]]]] = [
        (
            ...
            [
                ...
                ("Extra Checkpoint", fmt(cfg.model.load_checkpoint_extra) if cfg.model.load_checkpoint_extra else "[dim]—[/]"),
                ("LCE Opacity", f"{cfg.model.lce_opacity:.2f}" if cfg.model.load_checkpoint_extra else "[dim]—[/]"),
            ],
        ),
    ]
