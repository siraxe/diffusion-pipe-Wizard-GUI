...
MODEL_CONFIG = {
    ...
    "ltx-video": {
        ...
        "show_fields": {
            ...
            "first_frame_conditioning_p": True,
        },
        "defaults": {
    ...
    "wan22": {
        ...
        "show_fields": {
            ...
            "te1_lr": False,
            "te2_lr": False,
            "wan_mode": False,  # diffusion-pipe doesn't use wan_mode
            "wan_task": False,  # diffusion-pipe doesn't use wan_task
            "load_text_encoder_in_8bit": True,
            "gradient_checkpointing": True,
            "dropout": False,
            "first_frame_conditioning_p_ltx2": False,
        ...
        "defaults": {
            "ckpt_path": "models/Wan2.2-I2V-A14B",
    ...
    "_wan22": {
        ...
        "show_fields": {
            ...
            "te1_lr": False,
            "te2_lr": False,
            "wan_mode": True,  # musubi uses wan_mode in main config (though mostly in musubi section)
            "wan_task": True,  # musubi uses wan_task in main config (though mostly in musubi section)
            "load_text_encoder_in_8bit": True,
            "gradient_checkpointing": True,
            "dropout": False,
            "first_frame_conditioning_p": False,  # musubi doesn't use this
            "first_frame_conditioning_p_ltx2": False,
        },
        "defaults": {
            "ckpt_path": "models/Wan2.2-I2V-A14B",
            "transformer_path": "models/Wan2.2-I2V-A14B/high_noise_model",
            "wan_mode": "high",
            "wan_task": "t2v-A14B",  # Default to T2V for musubi
            "rank": 32,
            "alpha": 32,
        },
        "timestep_sm": "logit_normal",
    ...
    "flux2": {
        ...
        "defaults": {
            "diffusion_model": "models/FLUX.2-dev/flux2-dev.safetensors",
    ...
    "flux2_klein_4b": {
        ...
        "defaults": {
            "diffusion_model": "models/FLUX.2-klein-4B/flux-2-klein-base-4b.safetensors",
            "vae": "models/vae/flux2-vae.safetensors",
            "text_encoders": "models/text_encoders/qwen_3_4b.safetensors",
            "shift": "3",
        },
        "timestep_sm": "logit_normal",
    },
    "flux2_klein_9b": {
        ...
        "defaults": {
            "diffusion_model": "models/FLUX.2-klein-9B/flux-2-klein-base-9b.safetensors",
            "vae": "models/vae/flux2-vae.safetensors",
            "text_encoders": "models/text_encoders/qwen_3_8b.safetensors",
            "shift": "3",
        },
        "timestep_sm": "logit_normal",
    },
    ...
    "hunyuan-video": {
        ...
        "defaults": {
            "ckpt_path": "models/HunyuanVideo/ckpts",
...
DEFAULT_FIELD_VISIBILITY = {
    ...
    "nf4_te": False,
    "attn_chunking": False,
    # t_type dropdown field (LTX2 only) - replaces slider/ic_lora/vace_lora checkboxes
    "t_type": False,
    "sample_slider_range": False,
