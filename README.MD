...
```
git clone --recurse-submodules -b mus https://github.com/siraxe/diffusion-pipe-Wizard-GUI.git Dpipe
cd Dpipe
conda env create -f dp_env.yml -p ./dp_env
```

### 1.3 🗑️ Remove xformers (something adds it and creates issues wip)
